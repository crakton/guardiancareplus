...
import { ConnectionsList } from "@/components/client/ConnectionsList";
import { cn } from "@/lib/utils";
import {
  useGetClientOverview,
  useGetClientServices,
} from "@/hooks/useAnalyticsHooks";

// Service type labels for display
const SERVICE_TYPE_LABELS: Record<string, string> = {
  FULL_TIME_NANNY: "full_time_nanny",
  PART_TIME_NANNY: "part_time_nanny",
  DAILY_CLEANING: "daily_cleaning",
  WEEKLY_DEEP_CLEANING: "weekly_deep_cleaning",
  MEAL_PREPARATION: "meal_preparation",
  GROCERY_MANAGEMENT: "grocery_management",
  SCHOOL_TRANSPORT: "school_transport",
  ERRAND_RUNNING: "errand_running",
  LAUNDRY_ONLY: "laundry_only",
  LIVE_IN_HOUSEKEEPING: "live_in_housekeeping",
  LIVE_OUT_HOUSEKEEPING: "live_out_housekeeping",
  GARDENING_AND_LAWNCARE: "gardening_and_lawncare",
  SECURITY_GUARDING: "security_guarding",
  ELDER_CARE: "elder_care",
  COMPANION_CARE: "companion_care",
  HOMEWORK_HELP: "homework_help",
  EARLY_CHILD_TUTORING: "early_child_tutoring",
  WEEKEND_ONLY_SERVICE: "weekend_only_service",
  DRIVER_SERVICE: "driver_service",
  COOKING_FOR_EVENTS: "cooking_for_events",
};
...
export default function ClientDashboard() {
  ...
  const {
    ...
    error: overviewError,
  } = useGetClientOverview("month", true);
  const {
    data: serviceData,
    isLoading: serviceLoading,
    error: serviceError,
  } = useGetClientServices("month");
      ...
      <div className="container py-6 space-y-8">
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            <Activity className="mx-auto h-12 w-12 animate-spin text-guardian" />
