...
// API service function for client households
const clientHouseholdService = {
...
export default function ParticipantHouseholdsPage() {
  ...
  const {
    ...
    queryKey: ["client-households"],
    queryFn: () => clientHouseholdService.getHouseholds(),
  });
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-lg text-gray-600">
            Manage your households and support worker connections
          </p>
        </div>
        <div className="flex items-center gap-3">
          <Button
            ...
            onClick={() => {
              /* TODO: Add create household logic */
            }}
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 group">
          ...
          <CardContent className="p-6 relative">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="text-sm font-medium text-purple-600">Workers</p>
        ...
        <CardContent className="p-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-center">
            ...
            <div className="relative flex-1">
              ...
              <Input
                placeholder="Search households, workers, or invitations..."
                value={searchTerm}
          ...
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-600 max-w-md mx-auto mb-6">
              {searchTerm
                ...
                : "You don't have any households yet. Create your first household to start managing workers."}
            </p>
            {!searchTerm && (
              <Button
                className="bg-[#1e3b93] hover:bg-[#1e3b93]/90"
                ...
                <div className="flex items-start justify-between">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem
                        onClick={() =>
                          navigate(`/client/households/${household._id}`)
                        }
                      >
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-orange-50 rounded-lg">
                    ...
                    <span className="text-sm font-bold text-orange-900">
                      {household.pendingInvites.length}
                    </span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  {household.workers.length === 0 ? (
                    ...
                    <div className="space-y-3 max-h-48 overflow-y-auto">
                      {household.workers.slice(0, 3).map((worker) => (
                        <div
                          key={worker._id}
                      ...
                      {household.workers.length > 3 && (
                        <div className="text-center py-2">
                          <Button variant="ghost" size="sm" className="text-xs">
                            View {household.workers.length - 3} more workers
                          </Button>
                        </div>
                      )}
                    </div>
