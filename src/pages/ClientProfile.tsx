            ...
            <TabsContent value="bio">
              <Card className="border-[#1e3b93]/10 transition-all duration-200 hover:shadow-lg">
                <CardHeader className="border-b border-[#1e3b93]/10">
                  <CardTitle className="text-[#1e3b93]">About Me</CardTitle>
                </CardHeader>
                <CardContent className="space-y-6 pt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-[#1e3b93]/5 rounded-lg p-4">
                      <h3 className="text-md font-medium mb-3 flex items-center text-[#1e3b93]">
                    ...
                    <div className="space-y-4">
                      {upcomingAppointments.map((appointment) => (
                        ...
                        >
                          ...
                          <Button
                            size="sm"
                            className="bg-[#1e3b93] hover:bg-[#1e3b93]/90 mt-2"
                          >
                            View Details
                          </Button>
                        </div>
              ...
              <Card className="border-[#1e3b93]/10 transition-all duration-200 hover:shadow-lg">
                ...
                <CardContent className="pt-6">
                  {recentUpdates.length > 0 ? (
                      ...
                      {recentUpdates.map((update) => (
                        ...
                        >
                          <div className="flex items-center gap-2 mb-3">
                            <div className="w-8 h-8 rounded-lg bg-[#1e3b93]/10 flex items-center justify-center">
                              <FileText className="h-4 w-4 text-[#1e3b93]" />
                            </div>
                    ...
                    <div className="text-center py-12">
                      <div className="mx-auto w-16 h-16 bg-[#1e3b93]/10 rounded-full flex items-center justify-center mb-4">
                        <FileText className="w-6 h-6 text-[#1e3b93]/60" />
                      </div>
                      <p className="text-muted-foreground">
