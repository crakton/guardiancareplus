...
export enum CancellationReason {
  PARTICIPANT_REQUEST = "clientRequest",
...
export enum LocationType {
  IN_PERSON = "inPerson", // At client's address or specified location
...
export interface Shift {
  ...
  organizationId: string | Household; // Household this shift belongs to
  clientId: string | UserSummary; // Participant who created the shift
