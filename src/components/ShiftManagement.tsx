...
const availableParticipants = [
  {
    id: "p1",
    name: "Emma Davis",
    type: "client" as ParticipantType,
...
const ShiftManagement = () => {
  ...
  const handleCreateShift = () => {
    ...
    const selectedParticipant = availableParticipants.find(
      (p) => p.id === currentBooking.clientId
    );
      ...
      case 4:
        return (
          <div className="space-y-4">
            ...
            <div className="space-y-4 max-h-[400px] overflow-auto pr-2">
              {availableParticipants.map((client) => (
                <div
                  key={client.id}
                  className={`flex items-center justify-between p-3 border rounded-lg cursor-pointer ${
                  ...
                  onClick={() => updateCurrentBooking({ clientId: client.id })}
                >
                  <div className="flex items-center space-x-4">
                    <div className="w-10 h-10 rounded-full bg-guardian/10 flex items-center justify-center">
                      <User className="h-5 w-5 text-guardian" />
            ...
            <div className="pt-4 flex justify-between">
              ...
              <Button
                ...
                disabled={!currentBooking.clientId}
                className="bg-guardian hover:bg-guardian-dark"
              >
