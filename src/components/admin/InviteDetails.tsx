        ...
        <div className="md:col-span-2 space-y-6">
          <Card>
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                Details of the connection request between client and support
                worker
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                Details of the client requesting connection
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex items-center gap-4 mb-6">
                <Avatar className="h-16 w-16">
                  <AvatarFallback className="text-lg">
                    {getAvatarPlaceholder(inviteDetails.clientName)}
                  </AvatarFallback>
                </Avatar>
                <div>
                  <h3 className="text-lg font-semibold">
                    {inviteDetails.clientName}
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    {inviteDetails.organizationName}
                  </p>
                  <p className="text-xs text-muted-foreground mt-1">
                    ID: {inviteDetails.clientId}
                  </p>
                </div>
              </div>
