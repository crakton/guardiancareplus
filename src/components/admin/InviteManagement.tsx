...
export function InviteManagement() {
  ...
  const filteredInvitations = flattenedInvites.filter((invite) => {
    ...
    const matchesSearch =
      invite.clientName.toLowerCase().includes(searchLower) ||
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Manage client-to-support worker connection requests and monitor
            invitation status
          </p>
        </div>
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <Input
                  type="search"
                  placeholder="Search by client, worker, or household..."
                        ...
                        <div className="flex items-center gap-3">
                          <Avatar className="border-2 border-guardian/10">
                            <AvatarFallback className="bg-guardian/10 text-guardian font-medium">
                              {getAvatarPlaceholder(invitation.clientName)}
                            </AvatarFallback>
                          </Avatar>
                          <div>
