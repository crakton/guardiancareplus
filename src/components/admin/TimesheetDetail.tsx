        ...
        <Card className="max-w-4xl mx-auto">
          ...
          <CardContent>
            <p className="text-red-600">
              There was an error loading the timesheet details. Please try
              again.
            </p>
          </CardContent>
          <CardFooter>
            ...
            <CardHeader className="pb-4">
              <div className="flex flex-col gap-1">
                <div className="flex items-center justify-between">
                  <CardTitle>Shift {timesheet.shiftIdRef}</CardTitle>
                </div>
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <p className="text-sm">
                                  ...
                                  {formatCurrency(timesheet.distanceTravelRate)}
                                  /km
                                  <span className="text-xs text-muted-foreground ml-2">
                                    ={" "}
                                    {formatCurrency(
                                      timesheet.distanceTravelAmount
                                    )}
                                  </span>
                                </p>
                              </div>
                ...
                <TabsContent value="expenses" className="pt-4">
                  <div className="space-y-4">
                    ...
                    {timesheet.expenses.length === 0 ? (
                      <div className="bg-muted/30 p-4 rounded-lg">
                        <p className="text-sm text-muted-foreground italic">
                          No expenses claimed for this shift.
                        </p>
                      </div>
                    ) : (
                              ...
                              <TableCell className="font-medium">
                                <div>
                                  ...
                                  <div className="text-xs text-muted-foreground">
                                    ...
                                    {calc.rateTimeBandId.isWeekend &&
                                      " (Weekend)"}
                                    {calc.rateTimeBandId.isPublicHoliday &&
                                      " (Holiday)"}
                                  </div>
                                </div>
                              </TableCell>
                              <TableCell>
                                {formatCurrency(calc.hourlyRate)}/hr
                              </TableCell>
                        ...
                        {timesheet.distanceTravelAmount > 0 && (
                          <div className="flex justify-between items-center">
                            <span className="text-sm">
                              Travel ({timesheet.distanceTravelKm} km):
                            </span>
                            <span className="text-sm font-medium">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-3">
                ...
                <Button
                  variant="outline"
                  onClick={() =>
                    navigate(`/admin/shifts/${timesheet.shiftId._id}`)
                  }
                >
            ...
            <CardContent>
              <div className="flex items-center gap-4 mb-4">
                <Avatar className="h-12 w-12">
                  <AvatarFallback>
                    {timesheet.clientId.firstName.charAt(0)}
                    {timesheet.clientId.lastName.charAt(0)}
                  </AvatarFallback>
                </Avatar>
                <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm">{timesheet.clientId.email}</span>
                </div>

                <div className="flex items-center gap-3">
                  <Clock className="h-4 w-4 text-muted-foreground" />
                  <span className="text-sm">{timesheet.clientId.phone}</span>
                </div>
              </div>
              ...
              <div className="mt-4">
                <Button
                  ...
                  className="w-full"
                  onClick={() =>
                    navigate(`/admin/clients/${timesheet.clientId._id}`)
                  }
                >
