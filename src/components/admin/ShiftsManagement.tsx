...
export function ShiftsManagement() {
  ...
  const hasActiveFilters =
    ...
    startDateFilter ||
    endDateFilter ||
    (isMultiWorkerFilter && isMultiWorkerFilter !== "all");
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <Badge
        variant="outline"
        className={statusClasses[status] || "bg-gray-100 text-gray-800"}
      >
        {label}
      </Badge>
    );
  ...
  const getRecurrenceBadge = (recurrence: Recurrence) => {
    ...
    return (
      ...
      >
        ...
        {recurrence.pattern.charAt(0).toUpperCase() +
          recurrence.pattern.slice(1)}
      ...
      <CardHeader>
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          <div>
            ...
            <CardDescription>
              View and manage shifts across all households
            </CardDescription>
          </div>
                        ...
                        {shift.isMultiWorkerShift ? (
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-xs text-muted-foreground">
                                {shift.workerAssignments?.length || 0} workers
                                assigned
                              </span>
                            </div>
                          </div>
                      ...
                      <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem
                              onClick={() => handleViewShift(shift._id)}
                            >
