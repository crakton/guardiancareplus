...
const CreateIncidentModal = ({
  ...
  const filteredShifts = shifts?.filter((shift) => {
    ...
    const hasFirstName =
      typeof client === "object" && client !== null && "firstName" in client;
    const hasLastName =
      typeof client === "object" && client !== null && "lastName" in client;

    return (
      shift.shiftId.toLowerCase().includes(searchLower) ||
      (hasFirstName && client.firstName.toLowerCase().includes(searchLower)) ||
      (hasLastName && client.lastName.toLowerCase().includes(searchLower)) ||
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                <p className="text-sm font-medium text-gray-900">
                  {typeof selectedShift.clientId === "object" &&
                  selectedShift.clientId !== null
                    ? `${selectedShift.clientId.firstName} ${selectedShift.clientId.lastName}`
                    : String(selectedShift.clientId)}
                </p>
