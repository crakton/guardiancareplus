...
export function DashboardLayout({ children }: DashboardLayoutProps) {
        ...
        return (
          <>
            ...
            <NavItem
              ...
              icon={<Calendar size={20} />}
              label="My Shifts"
              active={isActive("/client/shifts")}
            />
            <NavItem
              to="/client/households"
              icon={<Building2 size={20} />}
              label="Households"
              active={isActive("/client/households")}
            />
            <NavItem
              to="/client/timesheets"
              icon={<FileText size={20} />}
              label="My Timesheets"
              active={isActive("/client/timesheets")}
            />
            <NavItem
              to="/client/incidents"
              icon={<ShieldCheck size={20} />}
              label="Incidents"
              active={isActive("/client/incidents")}
            />
            <NavItem
              to="/client/chats"
              icon={<MessageCircle size={20} />}
              label="Messages"
              active={isActive("/client/chats")}
            />
            {/* <NavItem
              to="/bookings"
              icon={<Calendar size={20} />}
        ...
        return (
          <>
            ...
            <NavItem
              ...
              icon={<Calendar size={20} />}
              label="Shifts"
              active={isActive("/worker/shifts")}
            />
            <NavItem
              to="/worker/households"
              icon={<Building2 size={20} />}
              label="Households"
              active={isActive("/worker/households")}
            />
            <NavItem
              to="/worker/timesheets"
              icon={<FileText size={20} />}
              label="My Timesheets"
              active={isActive("/worker/timesheets")}
            />
            <NavItem
              to="/worker/incidents"
              icon={<ShieldCheck size={20} />}
              label="Incidents"
              active={isActive("/worker/incidents")}
            />
            <NavItem
              to="/worker/chats"
              icon={<MessageCircle size={20} />}
              label="Messages"
              active={isActive("/worker/chats")}
            />
          </>
        );
      default:
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <SearchWorkers open={searchOpen} onOpenChange={setSearchOpen} />
    </div>
  );
}
