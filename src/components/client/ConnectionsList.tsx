...
export function ConnectionsList() {
  const [connections] = useState<Worker[]>(mockConnections);
    ...
    <Card>
      <CardHeader>
        <div className="flex justify-between items-center">
          <div>
            <CardTitle>My Worker Network</CardTitle>
            <CardDescription>
              View and interact with your connected workers
            </CardDescription>
          </div>
              ...
              <Card key={connection._id} className="overflow-hidden">
                <div className="flex flex-col h-full">
                  ...
                  <div className="p-4 pt-0">
                    <p className="text-sm text-muted-foreground mb-3">
                      {connection.experience && connection.experience[0]
                        ? `${connection.experience[0].title} at ${connection.experience[0].household}`
                  ...
                  <div className="flex justify-between items-center p-4 mt-auto">
                    <Link to={`/worker/profile/${connection._id}`}>
